...
(() => {
    ...
    const DICT = {
        es: {
            ...
            'toolbar.previewTitle': 'Ver el documento limpio sin guías de edición (P)',
            'toolbar.previewExitTitle': 'Salir de la vista previa y volver a editar (P)',
            'preview.badgeText': 'Modo Vista Previa · Clic o P para editar',
            ...
            'export.onlyModified': 'Solo bloques modificados (Recomendado)',
            'export.allEditableChk': 'Exportar todo el texto editable (Desaconsejado)',
            'export.allEditableConfirm': '⚠️ ¿Seguro que deseas activar "Todo el texto editable"?\n\nEste modo reconstruye todos los bloques del OCR y provocará textos superpuestos o duplicados si el fondo no se ha limpiado previamente con IA o goma.\n\nSe recomienda exportar "Solo bloques modificados" para preservar la nitidez y el diseño original intacto.\n\n¿Deseas activarlo de todas formas?',
            'export.allEditableWarning': '⚠️ Reconstruye todo el texto con OCR. Puede superponer textos sobre el fondo si no se limpiaron antes.',
        ...
        en: {
            ...
            'toolbar.previewTitle': 'Clean preview without editing guides (P)',
            'toolbar.previewExitTitle': 'Exit preview and return to editing (P)',
            'preview.badgeText': 'Preview Mode · Click or P to edit',
            ...
            'export.onlyModified': 'Only modified blocks (Recommended)',
            'export.allEditableChk': 'Export all text as editable (Not recommended)',
            'export.allEditableConfirm': '⚠️ Are you sure you want to enable "All editable text"?\n\nThis mode reconstructs all OCR blocks and will produce overlapping or duplicated text if the background has not been previously cleaned with AI or eraser.\n\n"Only modified blocks" is recommended to preserve original sharpness and layout intact.\n\nDo you want to enable it anyway?',
            'export.allEditableWarning': '⚠️ Reconstructs all text via OCR. May overlap with background image if not cleaned before.',
